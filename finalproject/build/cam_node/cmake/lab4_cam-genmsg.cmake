...
get_filename_component(_filename "/home/cc/ee106a/fa24/class/ee106a-abt/ee106a-finalproject/finalproject/src/cam_node/srv/ImageSrv.srv" NAME_WE)
add_custom_target(_lab4_cam_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "lab4_cam" "/home/cc/ee106a/fa24/class/ee106a-abt/ee106a-finalproject/finalproject/src/cam_node/srv/ImageSrv.srv" "std_msgs/Header:sensor_msgs/Image"
)
...
_generate_srv_cpp(lab4_cam
  "/home/cc/ee106a/fa24/class/ee106a-abt/ee106a-finalproject/finalproject/src/cam_node/srv/ImageSrv.srv"
  "${MSG_I_FLAGS}"
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/lab4_cam)
  install(CODE "execute_process(COMMAND \"/usr/bin/python3\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/lab4_cam\")")
  # install generated code
  install(
